...
let botaoAtualizar = document.getElementById('atualizar-saldo') as HTMLButtonElement,
    botaoLimpar = document.getElementById('limpar-saldo') as HTMLButtonElement,
    campoValorAdd = document.getElementById('campo-valor-add') as HTMLInputElement,
    campoSaldo = document.getElementById('campo-saldo') as HTMLSpanElement;
